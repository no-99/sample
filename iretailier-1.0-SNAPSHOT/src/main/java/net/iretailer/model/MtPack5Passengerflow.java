...
/**
 * MtPack5Passengerflow generated by hbm2java
 */
public class MtPack5Passengerflow implements java.io.Serializable {
	...
	public MtPack5Passengerflow() {
	}

	public MtPack5Passengerflow(int zoneId) {
		this.zoneId = zoneId;
	}

	public MtPack5Passengerflow(int zoneId, String date, Short dateHour, Short dateMin5, Short countEnter,
