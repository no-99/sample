...
/**
 * TPack60Wifidetect generated by hbm2java
 */
public class TPack60Wifidetect implements java.io.Serializable {
	...
	public TPack60Wifidetect() {
	}

	public TPack60Wifidetect(int zoneId) {
		this.zoneId = zoneId;
	}

	public TPack60Wifidetect(int zoneId, Date dateTime, String date, Short dateHour, Short dateMin5,
