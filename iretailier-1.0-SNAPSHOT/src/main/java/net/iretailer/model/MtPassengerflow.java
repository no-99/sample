...
/**
 * MtPassengerflow generated by hbm2java
 */
public class MtPassengerflow implements java.io.Serializable {
	...
	public MtPassengerflow() {
	}

	public MtPassengerflow(int zoneId) {
		this.zoneId = zoneId;
	}

	public MtPassengerflow(int zoneId, Date dateTime, Date date, Short dateHour, Short dateMin, Short dateMin5,
			Short countEnter, Short countExit) {
		this.zoneId = zoneId;
