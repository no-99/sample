...
/**
 * TWifidetect generated by hbm2java
 */
public class TWifidetect implements java.io.Serializable {
	...
	public TWifidetect(int zoneId) {
		this.zoneId = zoneId;
	}

	public TWifidetect(int zoneId, String macDetected, Integer visitTimes, Date firstTime, Date latestTime,
