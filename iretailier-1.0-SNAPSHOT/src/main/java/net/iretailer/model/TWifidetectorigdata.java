...
/**
 * TWifidetectorigdata generated by hbm2java
 */
public class TWifidetectorigdata implements java.io.Serializable {
	...
	public TWifidetectorigdata() {
	}

	public TWifidetectorigdata(int zoneId) {
		this.zoneId = zoneId;
	}

	public TWifidetectorigdata(int zoneId, Date dateTime, Date date, String ipaddr, String macDetected, Boolean enter,
