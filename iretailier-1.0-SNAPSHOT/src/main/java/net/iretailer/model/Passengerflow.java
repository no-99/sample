...
/**
 * Passengerflow generated by hbm2java
 */
public class Passengerflow implements java.io.Serializable {
	...
	public Passengerflow(int zoneId) {
		this.zoneId = zoneId;
	}

	public Passengerflow(int zoneId, Date dateTime, Date date, Short dateHour, Short dateMin, Short countEnter,
			Short countExit) {
		this.zoneId = zoneId;
